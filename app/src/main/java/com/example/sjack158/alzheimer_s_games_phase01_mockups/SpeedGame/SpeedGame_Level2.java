...
import com.example.sjack158.alzheimer_s_games_phase01_mockups.Game2;
...
//        });
    ...
    public void onClick( View v)
    {
        ...
        ref.child("speedgame").child("level02");
        ref.child("speedgame").child("level02").child("timestamp").child("ID:"+timeStampID).setValue(speedGameData.getTimeStamp());
        ref.child("speedgame").child("level02").child("timestamp").child("ID"+timeStampID).child(speedGameData.getTimeStamp())
