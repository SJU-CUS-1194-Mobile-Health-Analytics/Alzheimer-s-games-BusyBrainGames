...
public class Attention_Level3 extends  AppCompatActivity {
    ...
    public void onClick(View v)
    {
        ...
        ref.child("attentiongame").child("level03");
        ref.child("attentiongame").child("level03").child("timestamp").child("ID:"+timeStampID).setValue(attentionGameData.getTimeStamp());
        ref.child("attentiongame").child("level03").child("timestamp").child("ID"+timeStampID).child(attentionGameData.getTimeStamp())
