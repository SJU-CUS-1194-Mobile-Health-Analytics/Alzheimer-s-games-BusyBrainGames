...
public class Attention_Level1 extends AppCompatActivity{
    ...
    public void onClick(View v)
    {
        ...
        ref.child("attentiongame").child("level01");
        ref.child("attentiongame").child("level01").child("timestamp").child("ID:"+timeStampID).setValue(attentionGameData.getTimeStamp());
        ref.child("attentiongame").child("level01").child("timestamp").child("ID"+timeStampID).child(attentionGameData.getTimeStamp())
